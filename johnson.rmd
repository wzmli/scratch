...
Here are some sample distributions, generated on the linear scale. I used _90%_ CIs for this picture, I held constant at (25, 400), and varied the median linearly between them.

![](johnson_test.Rout-0.png)

And here is a similar picture, generated on the log scale (with the median varied on the log scale).
