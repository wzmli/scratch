...
Here are some sample distributions, generated on the linear scale. I held the 50% CI constant at (25, 400), and varied the median linearly between them.

And here is a similar picture, generated on the log scale (with the median also varied on the log scale).
